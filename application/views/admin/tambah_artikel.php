                     ...
                     <li class="mb-4">
                        <div class="content-item">
                          <div class="row row-1">
                            ...
                            <div class="col-12 ">
                            <div class="col-11"> 
                              <?php echo form_open('/admin/artikel_admin/tambah') ?>
                              <h5>Silahkan isi artikel anda</h5> 
                              <hr class="sidebar-divider d-none d-md-block" style="margin-right: 100px;">
                              <div class="input-group mb-3">
                                <input type="text" name="judul" class="form-control" placeholder="Masukkan Judul" aria-label="Username" aria-describedby="basic-addon1">
                             </div>
                             <div class="input-group mb-3">
                                <input type="text" name="caption" class="form-control" placeholder="Masukkan Caption" aria-label="Caption" aria-describedby="basic-addon1">
                             </div>
                             ...
                             <div class="input-group mb-3"><h5> Isi artikel :</h5><br>
                               <div class="col-12">
                                 <textarea name="isi" cols="10" rows="20" type="text" class="form-control" placeholder="Masukkan isi artikel" aria-label="Username" aria-describedby="basic-addon1"></textarea>
                               </div>
                             </div>
                             <br>
                             ...
                             <input type='hidden' name="n_author" value="<?php echo $user;  ?>">
                             <input type="hidden" name="k_author" value="<?php echo $jumlah+10;  ?>">
                             ...
                             <div class="input-group mb-3"><h5>Isikan link menuju gambar utama anda :</h5><br>
                               <div class="col-12">
                                 <input name="gambar" type="text" class="form-control" placeholder="Link untuk gambar utama" aria-label="" aria-describedby="basic-addon1"><br>
                               </div>
                              ...
                              <button class="btn btn-success" type="submit" name="kirim" value="upload" >Buat Artikel</button>
                            </div>
                          </div>
                        </div>
                      </li>
